...
public class EditorFieldOfView : Editor
{
    void OnSceneGUI()
    {
        ...
        Vector3 viewAngleA = Helpers.DirFromAngle(-fow.viewAngle/2, false, fow.transform);
        Vector3 viewAngleB = Helpers.DirFromAngle(fow.viewAngle/2, false, fow.transform);
